...
$contextPercent = 0  # Would need Claude API integration
$rateLimit = 0       # Would need Claude API integration
...
# Model and context would require integration with Claude Code
